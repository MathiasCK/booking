...
public class MainActivity extends AppCompatActivity {
    ...
    private void initNavLinks() {
        ...
        button_appointments.setOnClickListener(view -> {
            displayFragment(R.layout.fragment_appointments);
        });
        button_add_appointment.setOnClickListener(view -> {
            displayFragment(R.layout.fragment_add_appointment);
        });
    
        button_contacts.setOnClickListener(view -> {
            displayFragment(R.layout.fragment_contacts);
        });
        button_add_contact.setOnClickListener(view -> {
            displayFragment(R.layout.fragment_add_contact);
        });
    }
